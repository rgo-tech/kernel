...
int st_lsm6dsm_common_probe(struct lsm6dsm_data *cdata, int irq)
{
	...
	printk("ASSAF2: st_lsm6dsm_common_probe:entry\n");
	...
	printk("ASSAF2: st_lsm6dsm_common_probe: Who-Am-I=0x%x\n",wai);
	if (err < 0) {
	...
	printk("ASSAF2: st_lsm6dsm_common_probe: Done OK\n");
	return 0;

iio_device_unregister_and_trigger_deallocate:
	printk("ASSAF2: iio_device_unregister_and_trigger_deallocate\n");
	for (n--; n >= 0; n--)
...
deallocate_ring:
	printk("ASSAF2: deallocate_ring\n");
	st_lsm6dsm_deallocate_rings(cdata);
iio_device_free:
	printk("ASSAF2: iio_device_free\n");
	for (i--; i >= 0; i--)
		iio_device_free(cdata->indio_dev[i]);
free_fifo_data:
	printk("ASSAF2: free_fifo_data\n");
